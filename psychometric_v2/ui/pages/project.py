...
def render(
    ...
    st.markdown(
        '<div class="project-evidence-footnote">Archived master\'s-project summary from the 2023 college-student study reports N = 483; raw response data are no longer available.</div>',
        unsafe_allow_html=True,
    )
