...
def test_root_readme_presents_the_research_dossier() -> None:
    ...
    required_phrases = (
        ...
        "college students",
        "Archived master's-project materials report a sample of N = 483",
        "Cronbach's alpha .702-.887",
        "McDonald's omega .79-.87",
        "Participant-level data and protected study materials are not included",
        "the historical college-student results do not validate the current adolescent workbench",
